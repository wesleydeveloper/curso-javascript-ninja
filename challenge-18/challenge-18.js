...
var cpf = cleanCPF("049-214 3421-1");
function formatCPF(regex, g1, g2, g3, g4){
    return g1 + "." + g2 + "." + g3 + "-" + g4;
}
console.log( '\nFormatando CPFs corretamente:', cpf.replace(regexCPF, formatCPF) );
// ?
...
["junho", "julho"]
*/
var matchMonth = "Os meses de janeiro, junho e julho começam com a letra j.".match(/ju\w{3}/g)
console.log( '\nMatch com as palavras "junho" ou "julho" para a frase "Os meses de janeiro, junho e julho começam com a letra j.":', matchMonth );
// ?
...
*/
var htmlText = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
console.log( '\nMatch com a abertura de uma tag HTML:', htmlText.match(/<\w+>/g));
// ?
...
*/
var newHtml = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
console.log( '\nMatch com tags HTML vazias (abertura e fechamento da tag):', newHtml.match(/<\w+><\/\w+>/g));
// ?
...
*/
var textHtml = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
var regexHtml = /<(\w+)>([^<]+)<\/\w+>/g;
console.log( '\nFazer replace dos textos das tags:', textHtml.replace(regexHtml, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n'));
// ?
})()