(() => {
  ...
  */
  var peopleOne = { name: "Fernanda", lastname: "Silva"};
  var peopleTwo = { name: "Sarah", lastname: "Silva"};
  ...
  */
  console.log('O nome das pessoas é:\n', getFullName.call(peopleOne), "\n", getFullName.call(peopleTwo));
  ...
  */
  ...
  console.log(sum(3, 2, 1, 4, 2, 6, 4, 3))
  console.log(sum(2, 2, 3, 1, 5, 5, 7, 1))
  ...
  */
  ...
  function justNumbers(userEntry){
    var regex = /\D+/g;
    return userEntry.replace(regex, ',').split(',');
  }
