(function(){
    ...
    */
    ...
    console.log( five + ' é número?', typeof five.valueOf() === 'number' );
    ...
    */
    function showOperationMessage(o, x, y){
   ...
   console.log(showOperationMessage(operationSignal, number1, number2), !!teste ? teste(number1, number2): showErrorMessage(operationSignal));
